...
[Agency](https://startbootstrap.com/theme/agency) is a one page, agency portfolio theme built with [Bootstrap](https://getbootstrap.com/) created by [Start Bootstrap](https://startbootstrap.com/). This imported copy features several content sections, a responsive portfolio grid, modal windows for each portfolio item, and a static frontend contact form placeholder.
...
The contact form in this imported copy is a static frontend placeholder. It keeps the layout and native required-field validation, but it does not submit messages to any backend or external form service.

When remixing this template, connect the form to your own email, CRM, or backend endpoint if you need real message delivery.

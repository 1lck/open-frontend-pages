...
The imported copy keeps the original contact form markup as a static frontend placeholder. The upstream SB Forms API token attribute and external SB Forms script were removed so this template does not depend on a hosted form service. Connect the form to your own backend or form provider before using it in production.
